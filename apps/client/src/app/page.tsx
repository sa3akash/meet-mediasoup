    ...
    <div className="min-h-screen w-full bg-neutral-950 text-white flex flex-col justify-between selection:bg-indigo-500 selection:text-white">
      ...
      <header className="w-full px-8 py-5 flex items-center justify-between border-b border-white/5 backdrop-blur-md bg-neutral-950/70 sticky top-0 z-20">
        ...
        <nav className="flex items-center gap-4 text-sm font-medium">
          <a href="/login" className="px-4 py-2 rounded-full bg-neutral-900 hover:bg-neutral-800 border border-white/10 text-white text-xs transition-colors">
            Sign in
          </a>
          <a href="/signup" className="px-4 py-2 rounded-full bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-semibold transition-colors">
            Get Started
          </a>
        </nav>
      </header>
